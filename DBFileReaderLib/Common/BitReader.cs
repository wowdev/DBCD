...
namespace DBFileReaderLib.Common
{
    class BitReader
    {
        ...
        public BitReader(byte[] data) => Array = data;
        ...
        {
            uint result = Unsafe.As<byte, uint>(ref Array[Offset + (Position >> 3)]) << (32 - numBits - (Position & 7)) >> (32 - numBits);
            Position += numBits;
            return result;
        }
        ...
        {
            ulong result = Unsafe.As<byte, ulong>(ref Array[Offset + (Position >> 3)]) << (64 - numBits - (Position & 7)) >> (64 - numBits);
            Position += numBits;
            return result;
        }
        ...
        public BitReader Clone() => new BitReader(Array);
    }
}
